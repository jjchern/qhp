...
en_county_2014_map %>% mutate(year = 2014) -> en_county_2014_map
en_county_2015_map %>% mutate(year = 2015) -> en_county_2015_map
en_county_map = bind_rows(en_county_2014_map, en_county_2015_map)
...
ggplot() +
  geom_map(data = en_county_2014_map, map = en_county_2014_map,
           aes(x = long, y = lat, map_id = region, fill = enroll_per100000),
           colour = alpha("white", 0.1), size=0.2) +
  geom_map(data = state_map, map = state_map,
           aes(x = long, y = lat, map_id = region),
           colour = "white", fill = "NA") +
  coord_map("albers", lat0 = 30, lat1 = 40) +
  scale_fill_gradientn(colors = viridis::viridis(en_county_map$enroll_per100000, option = "B"),
                       limits=c(min(en_county_map$enroll_per100000, na.rm = TRUE),
                                max(en_county_map$enroll_per100000, na.rm = TRUE))) +
